...
public class C04_MethodOverloading {
    ...
    public static void main(String[] args) {
         ...
         /*
            ...
            4- Casting ile birden fazla method'u kullanabiliyorsa
               ...
               topla(3f , 4); argumentsi 2. ve 4. methodda çalışabilir ama 2. method 2 casting
               4. method 1 casting yapacağı için java daha az işlemli methodu kabul eder
         */
    ...
    public static void topla(double a, double b){ //java parametre içerisindeki ismi dikkate almaz data türüne bakar
