...
public class C03_Faktoryel {
    ...
    public static void main(String[] args) {
        ...
        //faktoryelHesapla(5); faktöryeli hesaplar ama kayıt altına almaz
        // kayıt altına alabilmek için işleme uygun data türüne atama yapılmalıdır
        ...
        public static int faktoryelHesapla(int sayı){//5
        int faktoryel=1;
