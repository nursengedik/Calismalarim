...
public class C06_WhileLoop {
    ...
    public static void main(String[] args) {
        ...
        while (toplam<500){ // toplam 500'den kucuk oldugu sure boyunca çalışacak
            System.out.println("Toplanmak uzere bir tamsayi giriniz");//sınırlar belli olmadığı için
                                                                      //kullanıcıdan sayı istenir

            girilenSayi= scan.nextInt();//kullanıcıdan sayıyı alırız
